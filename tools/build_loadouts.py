...
def main():
    ...
    lines = [
        ...
        '',
        '{{< alert >}}',
        'Generated by `tools/build_loadouts.py` from the game journal. '
        'A buildout only exists for a ship once it has been flown - hulls that '
        'have sat in storage the whole time have no `Loadout` event and so '
        'appear on [the fleet roster](/fleet/) but not here.',
        '{{< /alert >}}',
        '',
    ]
